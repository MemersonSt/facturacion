...
export default async function DashboardLayout({
  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-slate-50 p-3 md:p-6">
      {/* Background elegant orbs */}
      <div className="pointer-events-none absolute left-1/4 top-0 h-[360px] w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-200/35 blur-[90px]" />
      <div className="pointer-events-none absolute bottom-0 right-1/4 h-[420px] w-[420px] translate-x-1/3 translate-y-1/3 rounded-full bg-purple-200/35 blur-[100px]" />
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-rose-200/25 blur-[90px]" />
      ...
      <div className="relative mx-auto max-w-7xl space-y-4">
        <header className="relative overflow-hidden rounded-2xl border border-white/60 bg-white/75 px-4 py-3 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl md:px-5">
          <div className="pointer-events-none absolute -right-20 -top-20 h-56 w-56 rounded-full bg-gradient-to-br from-indigo-200 to-purple-200 opacity-35 blur-3xl" />
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-xs font-bold uppercase tracking-[0.18em] text-indigo-900/70">ARGSOFT</p>
